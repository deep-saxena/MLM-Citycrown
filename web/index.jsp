<!DOCTYPE html>
  ...
  <body>
  	...
  	<div class="container">
          	<div class="col-md-3 col-sm-6 templatemo_leftgap">
            	<div class="templatemo_mainservice templatemo_botgap">
                	<div class="templatemo_link"><a href="admin/admin_login.jsp">Administrator Login</a></div>
            ...
            <div class="col-md-3 col-sm-6 templatemo_leftgap">
                ...
                <div class="templatemo_mainportfolio">
                      <div class="templatemo_link"><a href="ClientReg/registration.jsp">New Client? Register</a></div>
                	                   
                </div>
            </div>
            <div class="col-md-3 col-sm-6 templatemo_leftgap">
            	<div class="templatemo_maintesti templatemo_botgap templatemo_topgap">
                	<div class="templatemo_link"><a href="ClientLogin/client_login.jsp">Client Login</a></div>
                </div>
            ...
            <div class="col-md-3 col-sm-6 templatemo_leftgap">
                ...
                <div class="templatemo_mainabout templatemo_botgap">
                	<div class="templatemo_link"><a href="about_us/about.jsp">About Us</a></div>
                </div>
                <div class="templatemo_maincontact">
                	<div class="templatemo_link"><a href="Contact_Us/contact_us.jsp">Contact</a></div>
                </div>
            </div>
    </div>
   ...
   <!-- <div class="portfolio" id="menu-3" style="display: none;" >
    ...
    <div class="logocontainer">
    	<div class="row">
            <div class="templatemo_footer">Copyright © CityCrown 2015</div>
       </div>
    </div>
    <!-- logo end -->  
